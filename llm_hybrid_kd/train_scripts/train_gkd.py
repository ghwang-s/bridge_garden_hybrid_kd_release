...
def parse_args():
    parser = argparse.ArgumentParser(description='GKD Training with DeepSpeed')
    

    parser.add_argument('--output_dir', type=str, default='./outputs/gkd')
...
def main():
    ...
    output_dir = f"{args.output_dir}/learning_rate_{args.learning_rate}_lmbda_{args.lmbda}_beta_{args.beta}"
    ...
    if is_main_process:
        print("\n" + "="*60)
        print("GKD Training Configuration:")
        print("="*60)
    ...
    if is_main_process:
        ...
        print("Teacher model will be instantiated inside GKDTrainer.\n")
